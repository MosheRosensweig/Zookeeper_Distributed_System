...
public class ZooKeeperLeaderElection
{
    ...
    private HashMap<Long, Vote> voteMap;
            ...
            switch (en.state) {
                ...
                case FOLLOWING:
                    if (haveEnoughVotes(voteMap, newVote)) {
                        Util2.printReplace("Server " + myPeerServer.getId() + " has enough votes for  " + newVote.getCandidateID() + " (I got a LEADING/LOOKING)", 2);
                        acceptElectionWinner(en);
                    }
                    break;
            }
        }
    ...
    private Vote acceptElectionWinner(ElectionNotification n)
    {
        ...
        myPeerServer.setPeerState((n.leader == myPeerServer.getId()) ? LEADING : FOLLOWING);
    ...
    {
        Util2.printReplace("Server " + myPeerServer.getId() + " sent notifications. Vote for " + proposedLeader, 2);
